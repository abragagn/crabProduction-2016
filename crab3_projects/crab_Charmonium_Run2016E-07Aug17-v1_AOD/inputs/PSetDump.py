...
process.cleanPatTrackCands = cms.EDProducer("PATGenericParticleCleaner",
    checkOverlaps = cms.PSet(
        electrons = cms.PSet(
            algorithm = cms.string('byDeltaR'),
            checkRecoComponents = cms.bool(False),
            deltaR = cms.double(0.3),
            pairCut = cms.string('0.5 < ele.pt/part.pt < 1.5'),
            preselection = cms.string(''),
    ...
    finalCut = cms.string(''),
    preselection = cms.string(''),
    src = cms.InputTag("selectedPatTrackCands")
)
...
process.patTrackCands = cms.EDProducer("PATGenericParticleProducer",
    addEfficiencies = cms.bool(False),
    addGenMatch = cms.bool(False),
...
process.selectedPatMuons = cms.EDFilter("PATMuonSelector",
    cut = cms.string('muonID("TMOneStationTight") && abs(innerTrack.dxy) < 0.3 && abs(innerTrack.dz)  < 20. && innerTrack.hitPattern.trackerLayersWithMeasurement > 5 && innerTrack.hitPattern.pixelLayersWithMeasurement > 0 && innerTrack.quality("highPurity")'),
...
process.selectedPatTrackCands = cms.EDFilter("PATGenericParticleSelector",
    cut = cms.string('pt > 0.7'),
...
process.pdAnalyzer = cms.EDAnalyzer("PDNtuplizer",
    ...
    savedTriggerObjects = cms.vstring('hltJet', 
        'hltMuon', 
        'hltTrack'),
    ...
    vertReco = cms.vstring('svtBuJPsiK', 
        'svtBdJPsiKx', 
        'svtBsJPsiPhi'),
...
process.p = cms.Path(process.pdAnalyzer)
...
process.GlobalTag = cms.ESSource("PoolDBESSource",
    ...
    globaltag = cms.string('80X_dataRun2_2016LegacyRepro_v3'),
